...
void loop()
{
  ...
  delay (3000);
  alinha();
  frente_zero (); //direita - tendo em conta a posição do sapo, movimenta-se para a direita 
  delay(500);
  frente_90 (); //direita - tendo em conta a posição do sapo, movimenta-se para a esquerda 
  delay(500);
  frente_180 (); //direita - tendo em conta a posição do sapo, movimenta-se para a direita 
  delay(500);
  frente_270 (); //direita - tendo em conta a posição do sapo, movimenta-se para a esquerda 
