...
void rodaCW()
{
  omni.mov_omni(0,80,0); //omni.mov_omni(linear ,rotação ,direção)Movimentar o robô
  delay(750);
  omni.mov_omni(0,0,0);
  delay(100);
...
void espiral()
{
  omni.mov_omni(50,20,0); //omni.mov_omni(linear ,rotação ,direção)Movimentar o robô
  delay (7000);
  omni.mov_omni(0,0,0);
  delay(1000);
}
