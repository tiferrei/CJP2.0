...
void rodaCW()
{
  omni.mov_omni(0,50,0); //omni.mov_omni(linear ,rotação ,direção)Movimentar o robô
  digitalWrite(leds, HIGH);
  delay (3000);
  digitalWrite(leds, LOW);
  omni.stop_motors();
...
void frente_90()
{
  omni.mov_omni(30,0,90); //omni.mov_omni(linear ,rotação ,direção)Movimentar o robô
  digitalWrite(leds, HIGH);
  delay (2000);
  digitalWrite(leds, LOW);
  omni.stop_motors();
...
void frente_180()
{
  omni.mov_omni(30,0,180); //omni.mov_omni(linear ,rotação ,direção)Movimentar o robô
  digitalWrite(leds, HIGH);
  delay (2000);
  digitalWrite(leds, LOW);
  omni.stop_motors();
...
void frente_270()
{
  omni.mov_omni(30,0,270); //omni.mov_omni(linear ,rotação ,direção)Movimentar o robô
  delay (2000);
  omni.stop_motors();
  (10);
}//------------------------------------------------
...
{
  while (bearing<180 || bearing>220)  // 200 Enquanto o robô estiver desalinhado   ||->ou lógico   &&->e lógico (valor inicial 80-180)
  {
